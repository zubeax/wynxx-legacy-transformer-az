      ...
      * Menu using cursor positioning for selection.
      *****************************************************************
       Data Division.
       ...
       01  Menu-Subscript                     pic s9(4) binary.
       01  Program-Name-Values.
           05  filler pic x(8) value 'ELISTP'.
           05  filler pic x(8) value 'EVIEWP'.
       01  Program-Names redefines Program-Name-Values.
           05  Program-Name occurs 2 pic x(8).    
       Procedure Division.    
           copy EINIT.
       ...
       1050-Get-User-Selection.
           perform varying Menu-Subscript
                   from 1 by 1
                   until Menu-Subscript greater than 2            
               move SEL1F(Menu-Subscript) to DFHBMFLG
               if DFHCURSR
                   move Program-Name(Menu-Subscript) to Next-Program
