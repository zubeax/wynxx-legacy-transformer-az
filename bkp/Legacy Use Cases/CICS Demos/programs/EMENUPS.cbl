      ...
      *****************************************************************
       ...
       01  MSG-Please-Enter-Selection.
           05  filler                         pic x(40)
               value 'Please type the number of your selection'.
           05  filler                         pic x(39)
               value ' and press Enter.'.
       01  MSG-Undefined-Selection.
           05  filler                         pic x(21)
               value 'Undefined selection: '.
           05  ERR-Selection                  pic x.
       ...
       0200-Populate-Initial-Screen.
           ...
           if MON-Category-Manager
               continue
           else
               move DFHPROTN to OPTADDA
           end-if        
       ...
       1000-Process-User-Input.
           ...
           evaluate EIBAID
               when DFHENTER
                   perform 1050-Get-User-Selection
               when DFHPF3
               when DFHPF12
                   perform 9200-Exit
               when DFHPF10
           ...
           .
       1050-Get-User-Selection.
           if SELCTL equal zero
               move MSG-Please-Enter-Selection to MSG-Out
               ...
               evaluate SELCTI
                   ...
                   when '3'
                       if MON-Category-Manager
                           move CON-Add-Program-Name to Next-Program
                           perform 1100-Transfer-Control
                       else
                           move SELCTI to ERR-Selection 
                           move MSG-Undefined-Selection to MSG-Out
                           set Highlight-Error to true
                       end-if
               end-evaluate
           end-if                                
